...
|    SI    |   SI   |  Proxmox VE  | Proxmox VE es una plataforma**open-source de virtualización** basada en Debian que permite gestionar **máquinas virtuales (KVM) y contenedores (LXC)** desde una interfaz web. Ofrece funciones como  **backups, snapshots, clustering y alta disponibilidad** , siendo muy utilizada tanto en servidores profesionales como en homelabs por su  **potencia y facilidad de uso** .                                                                                                                      |
